    ...
    <div>
      ...
      <form>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            <TextField required label="Nº do cartão" fullWidth inputProps={{ maxLength: 16 }} />
          </Grid>
          <Grid item xs={12} md={6}>
          ...
          <Grid item xs={12} md={6}>
            <Grid container spacing={3}>
              <Grid item xs={6}>
                <TextField required type="number" label="Exp. Mês" fullWidth />
              </Grid>
              <Grid item xs={6}>
                <TextField required type="number" label="Exp. Ano" fullWidth />
              </Grid>
            </Grid>
          </Grid>
        </Grid>
